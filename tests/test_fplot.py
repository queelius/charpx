"""Tests for the fplot function plotter."""
...
from extras.fplot.fplot import (
    evaluate_expression,
...
class TestMain:
    ...
    def test_help_exits(self, monkeypatch):
        """Test --help flag."""
        monkeypatch.setattr(sys, "argv", ["fplot", "--help"])
    ...
    def test_custom_range(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "x**2", "--xmin", "-2", "--xmax", "2", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_invalid_expression_exits(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "undefined_function(x)", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        with pytest.raises(SystemExit) as exc_info:
            main()
    ...
    def test_custom_y_range(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "--ymin", "-2", "--ymax", "2", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_invalid_color_exits(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "--color", "notacolor", "-w", "10", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        with pytest.raises(SystemExit) as exc_info:
            main()
...
class TestRendererSelection:
    ...
    def test_explicit_braille_renderer(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "-r", "braille", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_quadrants_renderer(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "-r", "quadrants", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_sextants_renderer(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "-r", "sextants", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_invalid_renderer_exits(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "-r", "notarenderer", "-w", "10", "-H", "5"]
        )
        with pytest.raises(SystemExit) as exc_info:
            main()
    ...
    def test_renderer_with_color(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "-r", "quadrants", "--color", "red", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_renderer_long_option(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "sin(x)", "--renderer", "sextants", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
...
class TestLegend:
    ...
    def test_legend_with_custom_colors(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "cos(x)", "--color", "blue", "-l", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: False)
        monkeypatch.setattr(sys.stdin, "read", lambda: json.dumps(first_output))
...
class TestParametric:
    ...
    def test_cli_parametric_with_custom_t_range(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "t*cos(t),t*sin(t)", "--tmin", "0", "--tmax", "12.56", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_cli_parametric_with_color(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "cos(t),sin(t)", "--color", "red", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_cli_parametric_with_explicit_x_range(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "cos(t),sin(t)", "--xmin", "-2", "--xmax", "2", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_cli_parametric_with_legend(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "cos(t),sin(t)", "-l", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: False)
        monkeypatch.setattr(sys.stdin, "read", lambda: json.dumps(first_output))
    ...
    def test_parametric_invalid_expression(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "undefined_func(t),sin(t)", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        with pytest.raises(SystemExit) as exc_info:
            main()
    ...
    def test_parametric_heart_curve(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "16*sin(t)**3,13*cos(t)-5*cos(2*t)-2*cos(3*t)-cos(4*t)", "-w", "20", "-H", "10"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
    ...
    def test_parametric_lissajous(self, monkeypatch, capsys):
        ...
        monkeypatch.setattr(
            sys, "argv",
            ["fplot", "-p", "sin(3*t),sin(2*t)", "-w", "20", "-H", "5"]
        )
        monkeypatch.setattr(sys.stdin, "isatty", lambda: True)
        main()
        captured = capsys.readouterr()
