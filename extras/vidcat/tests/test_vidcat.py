    ...
    def test_ffmpeg_failure_raises(self):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            with mock.patch("subprocess.run", side_effect=subprocess.CalledProcessError(1, "ffmpeg", stderr=b"error")):
                with mock.patch("vidcat.vidcat.get_video_info", return_value={"frame_count": 100, "fps": 30}):
...
class TestVidcatFunction:
    ...
    def test_ffmpeg_not_found(self):
        from vidcat.vidcat import vidcat

        with mock.patch("vidcat.vidcat.check_ffmpeg", return_value=False):
    ...
    def test_file_not_found(self):
        ...
        with mock.patch("vidcat.vidcat.check_ffmpeg", return_value=True):
...
class TestViewFunction:
    ...
    def test_view_delegates_to_vidcat(self):
        from vidcat.vidcat import view
...
class TestToAsciinema:
    ...
    def test_ffmpeg_not_found(self):
        from vidcat.vidcat import to_asciinema
    ...
    def test_help_without_video(self, capsys):
        ...
        with patch.object(sys, "argv", ["vidcat"]):
            with pytest.raises(SystemExit) as exc_info:
                from vidcat.vidcat import main
                main()
